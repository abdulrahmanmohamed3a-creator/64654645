  ...
  return (
    <section id="contact" className="section container" ref={ref}>
      ...
      <div className={`contact-wrapper ${isVisible ? 'fade-up visible' : 'fade-up'}`}>
        ...
        <form className="contact-form card" action="https://api.web3forms.com/submit" method="POST">
          <input type="hidden" name="access_key" value="d09bb092-3ccc-483f-973f-a6e12aa6266d" />
